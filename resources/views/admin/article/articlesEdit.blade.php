...
<body class="childrenBody">
	...
	<form class="layui-form" action="{{route('article.update')}}"  method="POST">
		 {{ csrf_field() }}
		 <input type="hidden" value="{{$article->article_id}}" name="article_id">
		<div class="layui-form-item">
			<label class="layui-form-label">文章标题</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input newsName" name="article_title"  value="{{$article->article_title}}" lay-verify="required" placeholder="请输入文章标题">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="text" class="layui-input newsAuthor" name="author" value="{{$article->author}}" lay-verify="required" placeholder="请输入文章作者">
				</div>
			</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="seokeywords" class="layui-input" value="{{$article->seokeywords}}"  placeholder="请输入文章关键字">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">内容摘要</label>
			<div class="layui-input-block">
				<textarea placeholder="请输入内容摘要"  name="article_desc" class="layui-textarea">{{$article->article_desc}}</textarea>
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">文章内容</label>
			<div class="layui-input-block">
				<textarea class="layui-textarea layui-hide" name="article_content" lay-verify="content" id="news_content">{{$article->article_content}}</textarea>
			</div>
		</div>
